...
public class CadastrarCliente extends JFrame {
	...
	public CadastrarCliente() {
		...
		lblNewLabel_1.setFont(new Font("Amiri", Font.BOLD, 30));
		lblNewLabel_1.setHorizontalAlignment(SwingConstants.RIGHT);
		lblNewLabel_1.setBounds(151, 174, 85, 23);
		contentPane.add(lblNewLabel_1);

		JLabel lblNewLabel_2 = new JLabel("Telefone:");
		lblNewLabel_2.setFont(new Font("Amiri", Font.BOLD, 30));
		...
		lblNewLabel_3.setFont(new Font("Amiri", Font.BOLD, 30));
		lblNewLabel_3.setHorizontalAlignment(SwingConstants.RIGHT);
		lblNewLabel_3.setBounds(117, 308, 119, 23);
		contentPane.add(lblNewLabel_3);

		JLabel lblNewLabel_4 = new JLabel("CPF:");
		lblNewLabel_4.setFont(new Font("Amiri", Font.BOLD, 30));
